/****** Object:  View [dbo].[Z_Matches7Days]    Script Date: 09/03/2020 20:32:36 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER VIEW [dbo].[Z_Matches7Days]
AS
SELECT 
...
FROM [Match] m
WHERE
	CONVERT(NVARCHAR(10), StartDate, 23) >= DATEADD(DAY,-7, getdate())
